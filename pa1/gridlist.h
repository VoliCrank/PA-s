...
class GridList {
  private:
    ...
    //
    //Helpers
    void MergeH(GridList &inner);
    void OddCheck(bool neg,GridNode *curr);
    void EvenCheck(bool check, GridNode *curr);
    void ReLink(GridNode *other);
    void CheckSwapShuffle(GridNode *curr, GridNode *other);
