...
TEST_CASE("GridList::Constructor - InsertBack - 1x1",
          "[weight=1][part=gridlist]") {
  PNG img(2, 2);
  GridList gl(img, 2);
...
TEST_CASE("GridList::Constructor - InsertBack - 2x1",
          "[weight=1][part=gridlist]") {
  PNG img(4, 2);
  GridList gl(img, 2);
...
TEST_CASE("GridList::Constructor - InsertBack - linking",
          "[weight=1][part=gridlist]") {
  PNG img(3, 1);
...
TEST_CASE("GridList::CheckerN-Render - odd width",
          "[weight=1][part=gridlist]") {
  PNG img(3, 3);
  HSLAPixel *p;
  for (int y = 0; y < 3; y++) {
...
TEST_CASE("GridList::CheckerN-Render - even width",
          "[weight=1][part=gridlist]") {
  PNG img(4, 3);
  HSLAPixel *p;
  for (int y = 0; y < 3; y++) {
...
TEST_CASE("GridList::Sandwich_H - even width outer",
          "[weight=1][part=gridlist]") {
  PNG img_outer(4, 2);
  HSLAPixel *p;
  for (int y = 0; y < 2; y++) {
...
TEST_CASE("GridList::Sandwich_H - odd width outer",
          "[weight=1][part=gridlist]") {
  PNG img_outer(3, 2);
  HSLAPixel *p;
  for (int y = 0; y < 2; y++) {
...
TEST_CASE("GridList::Sandwich_V - even height outer",
          "[weight=1][part=gridlist]") {
  PNG img_outer(2, 4);
  HSLAPixel *p;
  for (int y = 0; y < 4; y++) {
...
TEST_CASE("GridList::Sandwich_V - odd height outer",
          "[weight=1][part=gridlist]") {
  PNG img_outer(2, 3);
  HSLAPixel *p;
  for (int y = 0; y < 3; y++) {
...
TEST_CASE("GridList::Overloading constructor", "[weight=1][part=gridlist]") {
  PNG img_90(3, 3);
  HSLAPixel *p;
  for (int y = 0; y < 3; y++) {
    for (int x = 0; x < 3; x++) {
  ...
  GridList gl_270(img_270, 1);
  gl_90 = gl_270;
  GridNode * first = gl_90.getNorthWest();
  GridNode * second = gl_270.getNorthWest();
}